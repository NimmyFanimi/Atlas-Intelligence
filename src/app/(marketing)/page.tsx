  ...
  return (
    <div className="min-h-screen bg-[var(--color-background)] text-[var(--color-primary)] font-sans antialiased">
      ...
      <header className="flex items-center justify-between px-6 md:px-11 py-5 border-b border-[var(--color-border)]">
        ...
        <div className="flex items-center flex-wrap justify-end gap-2 sm:gap-4 md:gap-[22px]">
          <Link
            href="/docs"
          ...
          <a
            href="https://github.com/NimmyFanimi/Atlas-Intelligence"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 px-[10px] sm:px-[13px] py-[7px] border border-[var(--color-border)] rounded-[8px] text-[13px] font-sans text-[var(--color-secondary)] hover:border-[var(--color-muted)] hover:text-[var(--color-primary)] transition-colors cursor-pointer select-none"
          >
          ...
          <Link
            href="/dashboard"
            className="px-[14px] sm:px-[18px] py-[9px] bg-[var(--color-accent)] hover:bg-[var(--color-accent-hover)] text-[#04241F] text-[13.5px] font-sans font-semibold rounded-[8px] transition-colors"
          >
            Launch app
          </Link>
        </div>
      ...
      <section className="px-6 sm:px-10 pt-[84px] pb-[60px] text-center max-w-[720px] mx-auto">
        ...
        <h1 className="text-[28px] sm:text-[36px] md:text-[44px] font-semibold tracking-[-0.025em] leading-[1.18] mb-[22px] max-w-[640px] mx-auto">
