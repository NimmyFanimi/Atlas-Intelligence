      ...
      <header className="flex items-center justify-between px-6 md:px-11 py-5 border-b border-[var(--color-border)]">
        ...
        <div className="flex items-center gap-4 sm:gap-[22px]">
          ...
          <a
            ...
            className="flex items-center gap-2 px-[13px] py-[7px] border border-[var(--color-border)] rounded-[8px] text-[13px] font-sans text-[var(--color-secondary)] hover:border-[var(--color-muted)] hover:text-[var(--color-primary)] transition-colors cursor-pointer select-none"
          >
